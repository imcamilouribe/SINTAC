<?php
  ...
  <head>
    ...
    <title>Acceso - Sistema de Información de Tutorias Academicas</title>
    <!-- Bootstrap core CSS -->
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          ...
          <strong>Escribir clave<br>
            ...
            <a id="a11" href="https://tawk.to/chat/5b044119d0f6723da57ec4b8/default/?$_tawk_popout=true&$_tawk_sk=5b0441e6ba7dc7f6178883ea&$_tawk_tk=4704b5f209f1bedef2f8fcd64256f989&v=574" target="_blank" onclick="window.open(this.href, this.target, 'width=300,height=400'); return false;">He olvidado mi clave</a>
            <div>
              <br>
              <a id="login_button" href="index.php" class="btn btn-secondary" role="button">ATRAS</a>
