<?php
    ...
    if (isset($_SESSION['usuario'])) {
        ...
        if (isset($_POST['registrar_resultado'])) {
            ...
            $log = $log = "UPDATE `agenda` SET `resultado`= '$resultado' WHERE `id_estudiante` = '$codigo_estudiante' AND `fecha` = '$fecha_registro' AND `turno` = '$turno'";

            $sintac = mysqli_query($conectar, $log) or die("Algo ha ido mal en la consulta a la base de datos");

            echo '<script> alert("Se ha registrado el resultado");</script>';
            ...
            if (mysqli_num_rows($sintac) > 0) {
                ...
                echo '<script> window.location="registrar_resultado_tutoria.php"; </script>';
            }
            }else{
                echo '<script> alert("No se puede registar una fecha pasada o futura.");</script>';
                echo '<script> window.location="registrar_resultado_tutoria.php"; </script>';
            }
        ...
        <div class="container">
            <div class="row">
                <div id="bloque-presetancion" class="col-md-12">
                    <br>
                    <p class="text-center">
                        <strong>Registrar el resultado de una tutoría<br>
            </strong>
                        </strong>
                    </p>
                    <hr>
            ...
            echo '<div class="col-md-10 offset-md-1">
                        ...
                        <form action="registrar_resultado_tutoria_2.php" method="post">
                        ...
                        <div class="form-row mt-4">
                            ...
                            <div class="col-md-6 pb-3">
                                ...
                                <textarea class="form-control" name="resultado" maxlength="600" required>' . $resultado . '</textarea>
                                <small class="text-info">
                                  Obligatorio.
                                </small>
                            </div>
                        </div>
                        <center><button class="btn btn-lg btn-success btn-block col-md-4" name="registrar_resultado" type="submit">REGISTRAR RESULTADO</button></center>
                        </form>
                    </div>';
            ?>
        ...
        <div class="container">
            <div class="row">
                <div id="bloque-presetancion" class="col-md-12">
                    ...
                    <hr/>
                    <center>
                        <form id="form-desbloqueo" action="registrar_resultado_tutoria_2.php" method="post">
                            <div class="text-center mb-4">
                                <img class="mb-2" src="images/register.png" alt="" width="auto" height="80">
                                <hr>
                                <h1 class="h3 mb-3 font-weight-normal access"><b>RESULTADO DE TUTORÍA</b></h1>
                            </div>
