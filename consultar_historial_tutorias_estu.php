<?php
    ...
    if (isset($_SESSION['usuario'])) {
        ...
        $nom = $_SESSION['usuario'];
            ...
            $log = $log = "SELECT * FROM `agenda` WHERE `id_estudiante` = '$nom'";
            ...
            if (mysqli_num_rows($sintac) > 0) {
                ...
                echo '<script> alert("Usted no tiene tutorias agendadas.");</script>';
        ...
        <div class="container">
            <div class="row">
                <div id="bloque-presetancion" class="col-md-12">
                    <br>
                    <p class="text-center">
                        <strong>Todas las tutorías agendadas<br>
            </strong>
                        </strong>
                    </p>
                    <hr>
    ...
    include 'conexion.php';
            ...
            $result = mysqli_query($conectar, "SELECT * FROM `agenda` WHERE `id_estudiante` = '$nom' ORDER BY `fecha`");
