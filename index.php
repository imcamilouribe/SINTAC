    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <form class="form-signin" action="index_contraseña.php" method="post">
            <div class="text-center mb-4">
              <img class="mb-2" src="Images/SINTAC1.png" alt="" width="auto" height="80">
            </div>
            <hr>
            <h5>
          <strong>Iniciar sesión<br>
          </strong>
          </h5>
            <div class="form-label-group">
              ...
              <a id="a11" href="https://tawk.to/chat/5b044119d0f6723da57ec4b8/default/?$_tawk_popout=true&$_tawk_sk=5b0441e6ba7dc7f6178883ea&$_tawk_tk=4704b5f209f1bedef2f8fcd64256f989&v=574" target="_blank" onclick="window.open(this.href, this.target, 'width=300,height=400'); return false;">¿Olvidó su ID?</a>
            </div>
            <br>
            <div class="mb-3">
